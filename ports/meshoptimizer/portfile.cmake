...
if ("gltfpack" IN_LIST FEATURES)
    ...
    foreach(dependency_patch IN ITEMS cgltf-v1.2.patch fast-obj-v1.2.patch)
        vcpkg_execute_required_process(
            COMMAND "${GIT}" apply "${CURRENT_PORT_DIR}/${dependency_patch}"
            WORKING_DIRECTORY "${SOURCE_PATH}"
            LOGNAME "apply-${dependency_patch}"
        )
    endforeach()
endif()
