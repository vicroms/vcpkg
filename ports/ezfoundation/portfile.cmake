...
endforeach()
file(GLOB_RECURSE FOUNDATION_PLATFORM_INCLUDE_FILES "${SOURCE_PATH}/Code/Engine/Foundation/Platform/Win/*.h")
file(COPY ${FOUNDATION_PLATFORM_INCLUDE_FILES} DESTINATION "${CURRENT_PACKAGES_DIR}/include")
